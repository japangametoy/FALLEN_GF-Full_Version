 ...
 *
 * @arg 動作時間
 * @desc カメラ動作時間。5 なら 5フレーム 、1s なら 1秒。_2 付きで 2回 実行、_0 でループ実行。w 付きでウェイト
 *
 * @arg ズーム倍率
...
(() => {
    ...
    function updateZoomNo(sprite) {
        ...
        sprite._zoomRateKe = zoomScale < 1 ? Math.max(1, 1 / zoomScale * chara._zoomNoKe) : Math.min(1, 1 / zoomScale * chara._zoomNoKe);
        // 補正
        sprite.scale.x *= sprite._zoomRateKe;
        sprite.scale.y *= sprite._zoomRateKe;
    };
